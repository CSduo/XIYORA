...
const testCases = [
  {
    name: ".btn-ivory text on .btn-ivory background",
    fg: parseRgba("#1A1A1A"),
    bg: hexToRgb("#F5F2ED"),
    minRequired: 4.5,
  ...
  {
    name: ".btn-ivory hover text on dark hover background",
    fg: parseRgba("#FFFFFF"),
    bg: hexToRgb("#1A1A1A"),
    minRequired: 4.5,
    type: "Button Hover"
  ...
  {
    name: ".sl / .sec-label on dark background (#1A1A1A)",
    fg: parseRgba("#C8C3BA"),
    bg: hexToRgb("#1A1A1A"),
    minRequired: 4.5,
    type: "Section Label"
  ...
  {
    name: ".sl / .sec-label on dark background (#141414)",
    fg: parseRgba("#C8C3BA"),
    bg: hexToRgb("#141414"),
    minRequired: 4.5,
    type: "Section Label"
  ...
  {
    name: ".gold-grad start color (#E5DFCD) on dark background (#1A1A1A)",
    fg: parseRgba("#E5DFCD"),
    bg: hexToRgb("#1A1A1A"),
    minRequired: 4.5,
    type: "Gradient Text"
  ...
  {
    name: ".gold-grad end color (#C8C3BA) on dark background (#1A1A1A)",
    fg: parseRgba("#C8C3BA"),
    bg: hexToRgb("#1A1A1A"),
    minRequired: 4.5,
    type: "Gradient Text"
  ...
  {
    name: ".gold-italic (#E8D6B4) on dark background (#1A1A1A)",
    fg: parseRgba("#E8D6B4"),
    bg: hexToRgb("#1A1A1A"),
    minRequired: 4.5,
    type: "Italic Text"
  ...
  {
    name: ".bo / .btn-gold-out (#F5EEF0) on dark background (#1A1A1A)",
    fg: parseRgba("#F5EEF0"),
    bg: hexToRgb("#1A1A1A"),
    minRequired: 4.5,
    type: "Outline Button"
  ...
  {
    name: "SimplePage card text (C.dark / #1A1A1A @ 0.85) on white background (#FFFFFF)",
